...
def create_callbacks(model_name, log_dir=None, checkpoint_dir=None):
    """Create training callbacks with appropriate settings"""
    # Create log directory with timestamp for TensorBoard if not provided
    if log_dir is None:
...
def train_standard_model(
    ...
    # Create callbacks
    callbacks, log_dir, checkpoint_dir = create_callbacks(model_name)
